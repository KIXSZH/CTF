                      ...
                      <div id="chal2" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">HTTP -packets
                                <br><br>
                                ...
                                <div class="row justify-content-between">
                                  ...
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./challenges/0x20.html" class="btn btn-shadow text-mono btn-outline-success">Gothere</a>
                          ...
                          <div class="container">
                            ...
                            <div id="collapse2" class="panel-collapse collapse in">
                              <div class="panel-body">Be aDetective and Find the Secrets
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./challenges/0x21.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x21">
                                      <div class="input-group-append">
                            ...
                            <div id="collapse6" class="panel-collapse collapse in">
                              <div class="panel-body">------------------ 
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x22">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
