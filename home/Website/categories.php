...
<html lang="en">
  <head>
    ...
    <title>Byte Busters CTF Categories</title>
  ...
  <body>
    ...
    <h1 class="display-3" style="text-align: center"><b>Tech-Categories</b><span class="vim-caret">͏͏&nbsp;</span></h1>
                              ...
                              <br><br>
                                <div class="row justify-content-between">
                                  ...
                                  <div class="col-xl-12 align-self-center">
                                      <a href="../os.php" class="btn btn-shadow text-mono btn-outline-success">Go Deeper</a>
                                  </div>
                                  <br>
                                <br>
                                  <div class="col-xl-12 align-self-center">
                          ...
                          <div class="container">
                            ...
                            <div id="collapse2" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="../web.php" class="btn btn-shadow text-mono btn-outline-success">Go Deeper</a>                                     
                                    </div>
                                    <br>
                                <br>
                                  <div class="col-xl-12 align-self-center">
                          ...
                          <div class="container">
                            ...
                            <div id="collapse3" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                  <a href="../crypto.php" class="btn btn-shadow text-mono btn-outline-success">Go Deeper</a>                                     
                                    </div>
                                    <br>
                                <br>
                                  <div class="col-xl-12 align-self-center">
                          ...
                          <div class="container">
                            ...
                            <div id="collapse4" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="../stegno.php" class="btn btn-shadow text-mono btn-outline-success">Go Deeper</a>                                     
                                    </div>
                                    <br>
                                <br>
                                  <div class="col-xl-12 align-self-center">
                          ...
                          <div class="container">
                            ...
                            <div id="collapse5" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="../network.php" class="btn btn-shadow text-mono btn-outline-success">Go Deeper</a>                                     
                                    </div>
                                    <br>
                                <br>
                                  <div class="col-xl-12 align-self-center">
                          ...
                          <div class="container">
                            ...
                            <div id="collapse6" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="../linux.php" class="btn btn-shadow text-mono btn-outline-success">Go Deeper</a>                                     
                                    </div>
                                    <br>
                                <br>
                                  <div class="col-xl-12 align-self-center">
                          ...
                          <div class="container">
                            ...
                            <div id="collapse7" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="../python.php" class="btn btn-shadow text-mono btn-outline-success">Go Deeper</a>                                     
                                    </div>
                                    <br>
                                <br>
                                  <div class="col-xl-12 align-self-center">
