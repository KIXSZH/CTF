                      ...
                      <div id="chal2" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">Strings STR 
                                <br><br>
                                ...
                                <div class="row justify-content-between">
                                  ...
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x0D.html" class="btn btn-shadow text-mono btn-outline-success">Go There </a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      ...
                                      <input type="hidden" name="qnum" value="0x0D">
                      ...
                      <div id="chal3" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse2" class="panel-collapse collapse in">
                              <div class="panel-body">Just COnnect to SSH -GET a Flag 
                                <br><br>
                                <button type="button" class="btn btn-primary">EASY</button>
                                <br><br>
                                <?php if($result2){ ?>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x0E.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x0E">
                                      <div class="input-group-append">
                          ...
                          <div class="container">
                            ...
                            <div id="collapse3" class="panel-collapse collapse in">
                              <div class="panel-body">Debugger ---
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x0F.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x0F">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
                      ...
                      <div id="chal3" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse4" class="panel-collapse collapse in">
                              <div class="panel-body">Just Run A PrOgRaM in LiNuX -get Flag
                                <br><br>
                                <button type="button" class="btn btn-primary">EASY</button>
                                <br><br>
                                <?php if($result4){ ?>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x10.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x10">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
                      ...
                      <div id="chal3" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse5" class="panel-collapse collapse in">
                              <div class="panel-body">Ship-Game
                                <br><br>
                                <button type="button" class="btn btn-info">HARD</button>
                                <br><br>
                                <?php if($result5){ ?>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x11.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x11">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
                      ...
                      <div id="chal3" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse6" class="panel-collapse collapse in">
                              <div class="panel-body">--Random -Free Flag--
                                <br>
                                <button type="button" class="btn btn-primary">Easy</button>
                                <br>
                                <?php if($result6){ ?>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./challenges/0x12.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x12">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
