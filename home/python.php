...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="display-3" style="text-align: center"><b>PYTHON-QUIEST</b><span class="vim-caret">͏͏&nbsp;</span></h1>
                              ...
                              <div class="panel-body"> Crack the Arcane Calculator
                                ...
                                <div class="row justify-content-between">
                                  ...
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x17.html" class="btn btn-shadow text-mono btn-outline-success">GO there</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      ...
                                      <input type="hidden" name="qnum" value="0x17">
                      ...
                      <div id="chal3" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse2" class="panel-collapse collapse in">
                              <div class="panel-body"> XOR Decryption --
                              <br><br>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x18.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x18">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
                      ...
                      <div id="chal3" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse3" class="panel-collapse collapse in">
                              <div class="panel-body"> Brute FOrce Attack- 
                              <br><br>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x19.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x19">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
                          ...
                          <div class="container">
                            ...
                            <div id="collapse4" class="panel-collapse collapse in">
                              ...
                              <br><br>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x1A.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x1A">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
                      ...
                      <div id="chal3" class="panel panel-default mb-10 text-center">
                          <div class="container">
                            ...
                            <div id="collapse5" class="panel-collapse collapse in">
                              <div class="panel-body">Wait for the Onion to peel
                              <br><br>
                                <button type="button" class="btn btn-primary">EASY</button>
                                <br><br>
                                <?php if($result5){ ?>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x1B.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x1B">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
                            ...
                            <div id="collapse9" class="panel-collapse collapse in">
                              ...
                              <br><br>
                                ...
                                <div class="row justify-content-between">
                                  ...
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./Challenges/0x1C.html" class="btn btn-shadow text-mono btn-outline-success">Go THERE</a>
