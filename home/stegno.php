...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="display-3" style="text-align: center"><b>STEGNOGRAPHY</b><span class="vim-caret">͏͏&nbsp;</span></h1>
                              ...
                              <div class="panel-body">FInd Me inSide Me
                                ...
                                <div class="row justify-content-between">
                                  ...
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./challenges/0x02.html" class="btn btn-shadow text-mono btn-outline-success">GO there</a>
                          ...
                          <div class="container">
                            ...
                            <div id="collapse2" class="panel-collapse collapse in">
                              ...
                              <br><br>
                                ...
                                <div class="row justify-content-between">
                                  <div class="col-xl-12 align-self-center">
                                      <a href="./challenges/0x1D.html" class="btn btn-shadow text-mono btn-outline-success">Go There</a>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x1D">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
                            ...
                            <div id="collapse4" class="panel-collapse collapse in">
                              ...
                              <br><br>
                                ...
                                <form action="test.php" method="post">
                                  <div class="input-group mt-3">
                                      <input type="text" style="margin-left: 40px;" class="form-control" placeholder="Enter Flag" aria-label="Enter Flag" aria-describedby="basic-addon2" name = "flag">
                                      <input type="hidden" name="qnum" value="0x0L">
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-success" type="submit">GO!</button>
                                      </div>
